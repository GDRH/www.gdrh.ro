defmodule GdrhSiteWeb.MemberController do
  ...
  def new(conn, _params) do
    changeset = Team.change_member(%Member{})
  ...
  def update(conn, %{"id" => id, "member" => member_params}) do
    ...
    case Team.update_member(member, member_params) do
      {:ok, member} ->
        conn
  ...
  def delete(conn, %{"id" => id}) do
    member = Team.get_member!(id)
    {:ok, _member} = Team.delete_member(member)
